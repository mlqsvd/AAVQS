...
## Agrupamento simultâneo de objetos e variáveis baseado em funções de kernel {#projeto1}
...
## Agrupamento de séries temporais tipo-intervalo baseado em distâncias kernelizadas e adaptativas {#projeto2}

::: {style="text-align: justify"}
bla bla bla
:::

## Aprendizagem de máquina em espaços de dissimilaridade simbólicos {#projeto3}

::: {style="text-align: justify"}
bla bla bla
:::

## Métodos de agrupamento difuso usando graus de pertinência multivariados {#projeto4}
